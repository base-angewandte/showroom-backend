# Generated by Django 2.2.16 on 2021-03-29 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Entity')),
        ...
        migrations.AddField(
            model_name='activity',
            name='featured_media',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='featured_by', to='core.Media'),
        ),
        migrations.AddField(
            model_name='activity',
            name='parents',
            field=models.ManyToManyField(related_name='children', to='core.Activity'),
        ),
        migrations.AddField(
            model_name='activity',
            name='source_repo',
